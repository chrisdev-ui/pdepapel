...
const PROTECTED_ROUTES: ProtectedRoute[] = [
  ...
  { path: "offers", methods: ["POST", "DELETE", "PATCH"] },
  { path: "offers/scope-search", methods: ["GET"] },
  { path: "offers/scope-summary", methods: ["POST"] },
  { path: "offers/[offerId]", methods: ["PATCH", "DELETE", "PUT"], params: { offerId: "x" } },
