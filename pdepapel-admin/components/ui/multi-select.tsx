 ...
 * Uses YIQ color space formula for contrast.
 */
      ...
      <>
        ...
        >
          <div id={triggerDescriptionId} className="sr-only">
            Dropdown de selección múltiple. Usa las teclas de flecha para
            navegar, Enter para seleccionar y Escape para cerrar.
          </div>
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              aria-label={`Selección múltiple: ${selectedValues.length} de ${
                      ...
                      .map((value) => {
                        ...
                        const badgeStyle: React.CSSProperties = {
                          ...
                          ...(customStyle?.badgeColor && {
                            ...
                            color: getContrastingColor(customStyle.badgeColor),
                            border: "1px solid transparent", // hide border for custom colors
                          }),
