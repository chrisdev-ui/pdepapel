...
5. En **Categoría y fotos**, pulsa **Sugerir categoría** y elige una propuesta. Marca solo las fotos que correspondan al artículo: la primera será la portada. Si falta una foto, agrégala primero desde **Productos**. Al continuar, Administración confirma con Mercado Libre que la categoría exista y sea final; no uses una categoría general escrita a mano.
...
7. En **Revisar y publicar**, confirma producto, ambos precios, categoría, fotos y stock disponible. Pulsa **Calcular comisión** para una estimación: no incluye envío, impuestos o descuentos posteriores y no reemplaza el valor contable real. Si registraste costo de compra y una **ganancia objetivo después de costo y comisión**, pulsa **Sugerir precio de Mercado Libre**: calcula un precio de Mercado Libre para buscar esa meta. Revisa el resultado antes de publicar; nunca baja un precio de Mercado Libre que ya sea mayor ni modifica el precio de la tienda.
