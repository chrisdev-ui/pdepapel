...
export const ModelLabels: Record<Models, string> = {
  ...
  [Models.ProductKardex]: "Kardex del producto",
  [Models.MarketplaceSales]: "Ventas de Mercado Libre",
  [Models.MarketplaceListings]: "Publicaciones de Mercado Libre",
...
export const ModelsColumns: Record<Models, { [key: string]: string }> = {
  ...
  [Models.MarketplaceSales]: {
    ...
    totalAmount: "Cobrado",
    marketplaceFee: "Cargos",
    netAmount: "Neto",
    actions: "Acciones",
  },
  [Models.MarketplaceListings]: {
