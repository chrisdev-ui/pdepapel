...
- Runbooks in `docs/`: `mercadolibre.md` (application, OAuth, QStash, webhooks, listings, reconciliation), `guia-uso-mercadolibre.md`, `ventas-en-feria.md`, `conciliar-inventario-feria-anterior.md`, `punto-de-venta.md`, `reportes-tributarios.md`, `negocio-y-crecimiento.md`, `acceso-solo-lectura.md`, `google-merchant.md`, `nombres-productos.md`, `guia-panel-administracion.md`.
