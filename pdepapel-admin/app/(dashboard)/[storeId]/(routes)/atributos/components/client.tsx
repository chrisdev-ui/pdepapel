...
const AttributesClient: React.FC<AttributesClientProps> = ({ types, categories, sizes, colors, designs, options }) => {
  ...
  const sections: Record<Exclude<AttributeTab, "opciones">, { create: string; createLabel: string; description: string; empty: string; table: React.ReactNode }> = {
    categorias: {
      ...
      table: <DataTable tableKey={Models.Types} searchPlaceholder="Buscar categoría…" columns={typeColumns} data={visible.types} getRowId={(row) => row.id} bulkActions={(table) => <AttributeBulkActions kind="types" table={table} />} emptyState={emptyActive("Aún no hay categorías", `/${storeId}/tipos/nuevo`, "Crear la primera categoría")} />,
    },
    subcategorias: {
      ...
      table: <DataTable tableKey={Models.Categories} searchPlaceholder="Buscar subcategoría…" columns={categoryColumns} data={visible.categories} getRowId={(row) => row.id} bulkActions={(table) => <AttributeBulkActions kind="categories" table={table} />} emptyState={emptyActive("Aún no hay subcategorías", `/${storeId}/categorias/nuevo`, "Crear la primera subcategoría")} />,
    },
    tamanos: {
      ...
      table: <DataTable tableKey={Models.Sizes} searchPlaceholder="Buscar tamaño…" columns={sizeColumns} data={visible.sizes} getRowId={(row) => row.id} bulkActions={(table) => <AttributeBulkActions kind="sizes" table={table} />} emptyState={emptyActive("Aún no hay tamaños", `/${storeId}/tamanos/nuevo`, "Crear el primer tamaño")} />,
    },
    colores: {
      ...
      table: <DataTable tableKey={Models.Colors} searchPlaceholder="Buscar color…" columns={colorColumns} data={visible.colors} getRowId={(row) => row.id} bulkActions={(table) => <AttributeBulkActions kind="colors" table={table} />} emptyState={emptyActive("Aún no hay colores", `/${storeId}/colores/nuevo`, "Crear el primer color")} />,
    },
    disenos: {
      ...
      table: <DataTable tableKey={Models.Designs} searchPlaceholder="Buscar diseño…" columns={designColumns} data={visible.designs} getRowId={(row) => row.id} bulkActions={(table) => <AttributeBulkActions kind="designs" table={table} />} emptyState={emptyActive("Aún no hay diseños", `/${storeId}/disenos/nuevo`, "Crear el primer diseño")} />,
    },
  };
